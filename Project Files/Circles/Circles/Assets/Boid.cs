...
public class Boid : MonoBehaviour
{
    ...
    {
        // poop out a trail
        GameObject.Instantiate(trailPrefab, transform.position, Quaternion.identity);
        //Speed = MyFlock.Speed * 1.1f;
        ...
        else
        {
            ...
            Vector3 ranDir = UnityEngine.Random.insideUnitSphere;
            Vector3 swarmDir = MyFlock.target.transform.position - transform.position;
            Dir = (ranDir + swarmDir *0.2f + avoidance*2.0f + coherence + 0.36f* alignment).normalized;
